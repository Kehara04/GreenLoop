...
//                       className="absolute -bottom-2 -right-2 bg-primary-600 hover:bg-primary-700 text-white rounded-full p-2 cursor-pointer transition-colors"
//                     >
          ...
          <div className="lg:col-span-1">
            <nav className="space-y-2">
              <button
                ...
                style={{
                  backgroundColor: activeTab === 'profile' ? '#f0f9f0' : undefined,
                  color: activeTab === 'profile' ? '#184325' : undefined
                }}
              >
                Profile Information
              </button>
              <button
                ...
                style={{
                  backgroundColor: activeTab === 'password' ? '#f0f9f0' : undefined,
                  color: activeTab === 'password' ? '#184325' : undefined
                }}
              >
                Change Password
              </button>
