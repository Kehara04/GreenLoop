...
const Register = () => {
  ...
  return (
    <div className="relative min-h-screen w-full">
      ...
      <div className="fixed inset-0 w-full h-full bg-black bg-opacity-20"></div>
      
      {/* Content container */}
      <div className="relative z-10 min-h-screen flex items-center justify-start py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full ml-8 lg:ml-16">
