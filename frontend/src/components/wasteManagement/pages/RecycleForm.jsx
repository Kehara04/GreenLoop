...
// //   // Updated handleSubmit with actual API integration
...
// // //       // For demo purposes, if API fails, we'll simulate the response
...
// // //         };
// // //         setSubmittedData(simulatedData);
// // //         setCurrentPage('summary');
// // //       } else {
...
//         result = await response.json();
//       } catch {
//         // If no JSON response, create a fallback
//       }
...
//     setFormData({
//       categories: {
//         metal: 0, plastic: 0, polythene: 0,
//         eWaste: 0, clothes: 0, paper: 0, regiform: 0
//       },
//       location: { district: '', city: '' },
//       notes: ''
//     });
...
//     // Pass form data as state to the RecycleCentersPage
//     navigate('/recycle-centers', { 
//       state: { 
...
//                 <div className="text-4xl mb-3">🏪</div>
//                 <h3 className="font-semibold text-gray-800 mb-2 group-hover:text-green-600">Find Recycle Centers</h3>
//                 <p className="text-gray-600 text-sm">Locate nearby recycling facilities that accept your items</p>
//               </div>
//             </button>
